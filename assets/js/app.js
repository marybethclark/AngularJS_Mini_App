...
app.filter('searching',function(){
  ...
  return function(arr, stringToSearch){
    ...
    // forEach is used to loop through my array. ng-repeat can be used for this in html.  If I have time I'll try to make it work instead.
...
function yogaSearchController($scope){
  // my data is hardcoded below.  If I can get the rest to work, then I'll try a JSON call.
